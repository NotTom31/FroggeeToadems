...
# set to false for old implementation, true for brendan's implementation
@export var toggle_experimental_bounce = true

#normal implementation variables
@export var min_charge_time := 1.0
@export var max_charge_time := 3.0

#experimental implementation variables 
...
func play_charge_animation():
	if toggle_experimental_bounce == true:
